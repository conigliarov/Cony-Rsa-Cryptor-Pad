...
namespace RSACryptoPad
{
	public class MainForm : Form
	{
		...
		private string currentFileName = "Cony Rsa";		
		...
		public MainForm( string fileName )
		{
			...
			if( File.Exists( fileName ) )
			{
				...
				streamReader.Close();				
				this.Text = GetFileName( fileName ) + " - Nuovo";
				cleanForm = true;
			}
		}
		...
		private void InitializeComponent()
		{
            ...
            this.newFileMenuItem.Text = "Nuovo";
            ...
            this.openFileMenuItem.Text = "Apri...";
            ...
            this.saveAsFileMenuItem.Text = "Salva Come... ";
            ...
            this.undoMenuItem.Text = "Indietro";
            ...
            this.deleteMenuItem.Text = "Elimina";
            ...
            this.fontMenuItem});
            this.formatMenuItem.Text = "Formato";
            // 
            // wordWrapMenuItem
            // 
            ...
            this.wordWrapMenuItem.Text = "A capo automatico..";
            this.wordWrapMenuItem.Click += new System.EventHandler(this.wordWrapMenuItem_Click);
            // 
            // fontMenuItem
            // 
            this.fontMenuItem.Index = 1;
            this.fontMenuItem.Text = "Carattere...";
            ...
            this.generateKeyPairMenuItem.Text = "Genera Chiave Rsa...";
            ...
            this.processingLabel.Text = "Processando Attendere...";
            // 
            // pictureBox
            // 
		...
		private string openFile( string title, string filterString )
		{
			...
			if( openFileDialog.ShowDialog() == DialogResult.OK )
			{
				if( File.Exists( openFileDialog.FileName ) )
				{
					...
					if( fileString != null )
					{
						this.Text = GetFileName( openFileDialog.FileName ) + " - Nuovo";
		...
		private bool saveFile()
		{
			...
			if( saveFileDialog.ShowDialog() == DialogResult.OK )
			{
				try
				{
					...
					streamWriter.Close();
					this.Text = GetFileName( saveFileDialog.FileName ) + " - Nuovo";
		...
		private void mainForm_Load( object sender, EventArgs e )
		{
			...
			this.Text = GetFileName( currentFileName ) + " - Nuovo";
			inputTextBox.Focus();
		...
		private void inputTextBox_DragDrop( object sender, DragEventArgs e )
		{
			...
			if( clean )
			{
				if( e.Data.GetDataPresent( DataFormats.FileDrop, true ) == true )
				{
					...
					this.Text = GetFileName( fileNames[ 0 ] ) + " - Nuovo";
